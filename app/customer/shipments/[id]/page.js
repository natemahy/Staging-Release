...
export default function CustomerShipmentDetails() {
  ...
  useEffect(() => {
    // 1. Fetch data based on the ID in the URL (folder name [id])
  ...
  async function handleSave(e) {
    ...
    await saveShipmentChanges(formData) // This only updates the customer fields in actions.js
    setIsSaving(false)
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <Link href="/customer/shipments" className="flex items-center gap-2 text-slate-500 hover:text-green-600 mb-6 font-medium">
        ...
        <form onSubmit={handleSave}>
          ...
          {/* --- SECTION 1: CUSTOMER CONTROLS (EDITABLE) --- */}
          <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-green-100 mb-6">
            <div className="flex justify-between items-center mb-4 border-b pb-2">
              <div className="flex items-center gap-2">
                <UserCheck className="text-green-600" />
                <h2 className="text-lg font-bold text-slate-900">My Approval Controls</h2>
              </div>
              <button disabled={isSaving} className="bg-green-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-green-700 flex items-center gap-2 shadow-md transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Approval Status</label>
                <select name="company_status" defaultValue={shipment.company_status || ''} className="w-full p-2 border rounded bg-white text-gray-900 font-bold focus:ring-2 focus:ring-green-500 outline-none">
              ...
              <div>
                ...
                <select name="company_inspection" defaultValue={shipment.company_inspection || ''} className="w-full p-2 border rounded bg-white text-gray-900 font-bold focus:ring-2 focus:ring-green-500 outline-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                <h3 className="font-bold text-slate-900 text-lg mb-4 flex items-center gap-2 border-b pb-2">
                  <Hash className="text-blue-500" size={20} /> Shipment Details (Read Only)
                </h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <DetailBox label="Warehouse Cell" value={shipment.warehouse_column_cell} />
                  <div>
                    <p className="text-xs text-slate-400 uppercase font-bold mb-1">Vendor Status</p>
