...
import { ArrowLeft, Send, Save, AlertTriangle, FileText, Camera, User, Hash, Calendar } from 'lucide-react'
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                     ...
                     <select name="status" defaultValue={shipment.status} className="w-full p-2 border rounded bg-white text-gray-900 font-bold">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                ...
                {shipment.pdf_submission ? (
                  <a href={shipment.pdf_submission} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-3 border rounded-lg bg-red-50 text-red-700 font-bold hover:bg-red-100">
